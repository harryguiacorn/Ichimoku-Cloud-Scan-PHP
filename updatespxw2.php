<html>
	<head>
		...
		<title>Cloud S&P 500 Signals</title>
...
<?php
	...
	define('DATA_PATH','data/spx500/');
	define('XML_PATH_STOCK_LIST','xml/SPX500.xml');
	define('DEBUG_MODE',true);
	//date_default_timezone_set('Europe/London');//for UK market only
	ini_set('max_execution_time', 300); //300 seconds = 5 minutes
	$_cloudSignalMain = new CloudSignalMain("Cloud Signals","S&P 500 shares");
	$_cloudSignalMain->init(CloudUtility::UPDATE_MODE_WEEKLY_SPX500_PART2_FROM_SCRATCH);
