<html>
	<head>
		...
		<title>Cloud STOXX 50 Signals</title>
...
<?php
	...
	define('DATA_PATH','data/estoxx/');
	define('XML_PATH_STOCK_LIST','xml/Estoxx.xml');
	define('DEBUG_MODE',true);
	//date_default_timezone_set('Europe/London');//for UK market only
	ini_set('max_execution_time', 300); //300 seconds = 5 minutes
	$_cloudSignalMain = new CloudSignalMain("Cloud Signals","EURO STOXX 50 shares");
	$_cloudSignalMain->init(CloudUtility::UPDATE_MODE_WEEKLY_ESTOXX_FROM_SCRATCH);
